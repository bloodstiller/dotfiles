...
:header-args: emacs-lisp :tangle ~/.dotfiles/packages/doom/config/config.el
:END:
** General Settings:
:PROPERTIES:
...
:header-args: emacs-lisp :tangle ~/.dotfiles/packages/doom/config/packages.el
:END:
...
:header-args: emacs-lisp :tangle ~/.dotfiles/packages/doom/config/init.el
:END:
...
:header-args: emacs-lisp :tangle ~/.dotfiles/packages/doom/config/custom.el
:END:
